...
const MESSAGES = {
  'pt-BR': {
    ...
    chatDone: 'Resposta pronta',
    chatDoneDescription: 'O agente terminou de responder no chat.',
    chatFailed: 'Resposta do chat falhou',
  ...
  en: {
    ...
    chatDone: 'Reply ready',
    chatDoneDescription: 'The agent finished replying in chat.',
    chatFailed: 'Chat reply failed',
